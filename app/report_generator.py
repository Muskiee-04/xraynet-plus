...
class PDFReportGenerator:
    ...
    def generate_report(self, patient_data, analysis_results, output_path=None, gemini_appendix=None):
        """
        ...
        if gemini_appendix and str(gemini_appendix).strip():
            story.extend(self._create_gemini_appendix_section(str(gemini_appendix).strip()))
    ...
    def _create_header(self):
        ...
        # Subtitle
        subtitle = Paragraph("ChestRay Gemini — AI screening + optional Gemini narrative", self.styles['Heading2'])
    ...
    def _create_gemini_appendix_section(self, text: str):
        """Optional educational narrative from Google Gemini (plain text / markdown-ish)."""
        elements = []
        elements.append(Paragraph("GEMINI EDUCATIONAL NARRATIVE (OPTIONAL)", self.custom_styles['Heading']))
        elements.append(Spacer(1, 8))
        note = Paragraph(
            "The following section was generated by an external LLM for teaching and discussion. "
            "It is not a radiology report and must not be used as a sole basis for care.",
    ...
    def _create_footer(self):
        ...
        disclaimer = Paragraph(
            "This report was generated by ChestRay Gemini (local CNN + optional Google Gemini API). "
...
def generate_report(patient_data, results, output_path=None, gemini_appendix=None):
    """
    Standalone function for backward compatibility
    """
    generator = PDFReportGenerator()
    return generator.generate_report(patient_data, results, output_path, gemini_appendix=gemini_appendix)